...
@SourceType(value = "BasecampARP", label = "Basecamp",uiConfig = "basecamp-layout.json")
public class BasecampConf extends AbstractArpConf<BasecampConf> {
  private static final String ARP_FILENAME = "arp/implementation/basecamp-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.basecamp.BasecampDriver";
